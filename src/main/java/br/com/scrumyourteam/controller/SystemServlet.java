...
//            *******************************check
//            RequestDispatcher rd = request.getRequestDispatcher("/ScrumYourTeam/index.html");//check
//            rd.forward(request,response);
            
            request.getRequestDispatcher("/ScrumYourTeam/index.html").forward(request,response);;
        }
    }
